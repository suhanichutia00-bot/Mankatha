...
const RiskDetection = () => {
  ...
  return (
    <div className="risk-page">
      ...
      <div className="risk-flower risk-flower-left">
        🌻
      </div>

      <div className="risk-flower risk-flower-right">
        🌼
      </div>

      <div className="risk-butterfly risk-butterfly-left">
        🦋
      </div>

      <div className="risk-butterfly risk-butterfly-right">
        🦋
      </div>
